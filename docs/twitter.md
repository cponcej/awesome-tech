...
[![If drivers were hired like programmers](images/drivers_hired_like_programmers.jpg)](https://www.jitbit.com/alexblog/203-what-if-drivers-were-hired-like-programmers/){:style="float: right;margin-right: 7px;margin-top: 7px;"}
